...
namespace SuperSocket.ProtoBase.Runtime
{
    public abstract class BeginEndMarkPipelineFilter2<TPackageInfo> : PipelineFilterBase<TPackageInfo>
        where TPackageInfo : class
    {
        ...
        protected BeginEndMarkPipelineFilter2(ReadOnlyMemory<byte> beginMark, ReadOnlyMemory<byte> endMark)
        {
