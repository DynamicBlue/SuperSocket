...
namespace SuperSocket.ProtoBase.Config
{
    public class SimpleSocketConfig
    {
        public SimpleSocketConfig()
        {
            ...
            this.ReceiveBufferSize = 1024 * 8; ;
            this.SendBufferSize = 1024*8;
            this.DisableSessionSnapshot = true;
            this.Name = "IoTTerminal";
            this.MaxCompletionPortThreads = 10000;
            this.PerformanceDataCollectInterval = 120;
            this.DisablePerformanceDataCollector = false;
            this.ServerTypeNiceName = "IoTTerminalService";
            this.ServerTypeFullName = "IoT.Service,IoT.Protocols";
        ...
        // 4M by default
        public int MaxPackageLength { get; set; } = 1024 * 1024 * 8;
